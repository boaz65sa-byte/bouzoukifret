...
> קובץ זה מתעדכן בסוף כל סבב עבודה, כדי שאפשר יהיה להבין מה נעשה ומה נשאר בלי לסרוק מחדש את כל הקוד. עדכון אחרון: 2026-07-16 — הכנה ל-Google Play + App Store (ראו `STORE-SUBMISSION.md` להוראות הגשה מלאות).
